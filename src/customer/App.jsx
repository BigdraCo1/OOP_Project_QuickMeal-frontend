  ...
  return (
    <>
      <section className="grid place-items-center bg-emerald-900 p-16 min-h-screen">
        <div className="bg-slate-300 p-4 pb-0 shadow-lg rounded-lg">
          <div className="flex gap-2 relative sm:rounded-lg">
            ...
            <button
              className="h-12 min-w-[8rem] text-[1.1rem] font-medium transition-all duration-500 rounded-lg hover:rounded-md 
              border-[3px] border-emerald-600 bg-slate-100 hover:bg-emerald-600 text-emerald-600 hover:text-slate-200 shadow-lg
          ...
          {isLoading ? (
            ...
            todos.map((todo, index) => (
              <div key={index} className="border border-gray-200 p-4 mb-4 rounded-md bg-white flex flex-col justify-center items-center hover:p-6 transition-all duration-300">
