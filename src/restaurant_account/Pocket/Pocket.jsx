    ...
    return (
        ...
        bg-slate-100 justify-start items-start h-screen '>
            ...
            <div className='p-[1rem] h-screen w-full'>
                ...
                <div 
                // className='text-[1.2rem] border-2 border-slate-300 rounded-md shadow-md my-[0.5rem] px-[1rem] py-[0.5rem]'
                className='text-[1.2rem] font-medium border-2 border-slate-300 rounded-md shadow-md my-[0.5rem] px-[1rem] py-[0.5rem]'
                >
                ...
                <div className='flex bg-slate-300 my-[0.5rem] p-[0.5rem] rounded-md w-full'>
                    ...
                    <div>
                        <textarea id="money" name="money" rows="1" cols="20"></textarea><br/>
                    </div>
                    <div>
